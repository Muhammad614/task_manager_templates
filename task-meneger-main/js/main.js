...
function activeSidebarFunction() {
	let sidebar = document.querySelector('.responsive-sidebar')
	sidebar.classList.add('active')
	// document.querySelector('header').style = 'filter: blur(15px) !important;'
	document.querySelector('.blurs').classList.add('active')
	// document.querySelector('body').style = 'filter: blur(15px) !important;'
	// sidebar.style = 'filter: blur(0px) !important;'
}

function removeActiveClass() {
	let sidebar = document.querySelector('.responsive-sidebar')
	sidebar.classList.remove('active')
	document.querySelector('.blurs').classList.remove('active')
}